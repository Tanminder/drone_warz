...
class DiscussionsControllerTest < ActionController::TestCase
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post :create, discussion: { body: @discussion.body, league_id: @discussion.league_id, member_id: @discussion.member_id, title: @discussion.title }
    end
  ...
  test "should update discussion" do
    patch :update, id: @discussion, discussion: { body: @discussion.body, league_id: @discussion.league_id, member_id: @discussion.member_id, title: @discussion.title }
    assert_redirected_to discussion_path(assigns(:discussion))
  end
